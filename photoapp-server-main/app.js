...
let analyze = require('./api_labels.js');
let search = require('./api_images.js');
...
app.get('/labels/:assetid', analyze.analyze_image);
app.get('/images/:label', search.search_images);
